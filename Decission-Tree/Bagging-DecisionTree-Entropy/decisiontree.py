...
def learn_decision_tree(examples, attributes, default, target, iteration, num_attr,):
...
def main():
    ...
    learned_tree = learn_decision_tree(train_data,attr_names,default,target,0,num_attr,)
