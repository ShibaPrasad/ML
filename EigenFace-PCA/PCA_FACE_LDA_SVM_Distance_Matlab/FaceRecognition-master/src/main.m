...
addpath 'C:\Users\Shiba\Desktop\ML\EigenFace-PCA\FaceRecognition_Master\FaceRecognition-master\libsvm-3.22\libsvm-3.22\windows'
% cd ('C:\Users\Shiba\Desktop\ML\EigenFace-PCA\FaceRecognition_Master\FaceRecognition-master')

% Choose simple, pose variation, or illumination variation dataset 
dataset = input('Please select your dataset: \n(1) simple.m \n(2) pose.m\n');

if dataset == 1
     load 'C:/Users/Shiba/Desktop/ML/EigenFace-PCA/FaceRecognition_Master/FaceRecognition-master/data/simple.mat'
     %Define variables
     k = 200;% Number of classes
     n = 3;% Number of images per class 
elseif dataset == 2
     load 'C:/Users/Shiba/Desktop/ML/EigenFace-PCA/FaceRecognition_Master/FaceRecognition-master/data/pose.mat'
     face = pose;
    %Define variables
